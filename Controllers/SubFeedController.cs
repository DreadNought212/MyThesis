...
{
    public class SubFeedController : Controller
    {
            ...
            )
        {
            ...
            db_followers = following_context;
        }
        [Authorize]
        ...
        public async Task<IActionResult> Index(int id)
        {
            ...
            foreach (UserFollower follow in await db_followers.Following
                .Where(u => u.FollowerId == user.Id)
                .ToListAsync())        
            {
                followingId.Add(follow.UserID);
            ...
            ViewBag.WallPosts = db_post.WallPosts
                        ...
                        .Where(u => followingId.Contains((int)u.UserId))
                        .Include(u => u.User)
